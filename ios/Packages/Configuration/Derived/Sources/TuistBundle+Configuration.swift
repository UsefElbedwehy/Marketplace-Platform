...
/// Since Configuration is a static framework, the bundle containing the resources is copied into the final product.
    nonisolated static let module: Bundle = {
        let bundleName = "Configuration_Configuration"
        ...
        fatalError("unable to find bundle named Configuration_Configuration")
    }()
}
